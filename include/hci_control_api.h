...
#define HCI_CONTROL_COMMAND_PUSH_NVRAM_DATA_LONG            ( ( HCI_CONTROL_GROUP_DEVICE << 8 ) | 0x17 )    /* Download previously saved NVRAM chunk having higher length */
...
#define HCI_CONTROL_LE_AUDIO_COMMAND_TERMINATE_PA_SYNC     ( ( HCI_CONTROL_GROUP_LE_AUDIO << 8 ) | 0x2A )
#define HCI_CONTROL_LE_AUDIO_COMMAND_CONVO_STREAM_START_STOP ( ( HCI_CONTROL_GROUP_LE_AUDIO << 8 ) | 0x2B )
#define HCI_CONTROL_LE_AUDIO_COMMAND_SET_LOCK_STATE          ( ( HCI_CONTROL_GROUP_LE_AUDIO << 8 ) | 0x2C )
...
/* RAS Host commands */
#define HCI_CONTROL_RAS_START_CS_PROCEDURE        ( ( HCI_CONTROL_GROUP_RAS << 8 ) | 0x00 ) /* Start CS procedure */
#define HCI_CONTROL_RAS_STOP_CS_PROCEDURE         ( ( HCI_CONTROL_GROUP_RAS << 8 ) | 0x01 ) /* Stop CS procedure */
#define HCI_CONTROL_RAS_INCREMENT_TEST_ITERATION  ( ( HCI_CONTROL_GROUP_RAS << 8 ) | 0xff ) /* Increment step count */
...
#define HCI_CONTROL_EVENT_IDENTITY_KEYS                     ( ( HCI_CONTROL_GROUP_DEVICE << 8 ) | 0x14 )    /* Identity Keys Update */
...
#define HCI_CONTROL_MISC_EVENT_APP_STATUS                   ( ( HCI_CONTROL_GROUP_MISC << 8 ) | 0x03 )    /* App status */
...
#if (HCI_CONTROL_LE_AUDIO_EVENT_REQUEST_DATA != 0x300d)
#error ("HCI_CONTROL_LE_AUDIO_EVENT_REQUEST_DATA should be 0x300d")
#elif (HCI_CONTROL_LE_AUDIO_EVENT_STARTED != 0x300e)
#error ("HCI_CONTROL_LE_AUDIO_EVENT_STARTED should be 0x300e")
#elif (HCI_CONTROL_LE_AUDIO_EVENT_STOPPED != 0x300f)
#error ("HCI_CONTROL_LE_AUDIO_EVENT_STOPPED should be 0x300f")
#endif

/* End of macros from audio module */
#define HCI_CONTROL_LE_AUDIO_EVENT_BIS_INFO                 ( ( HCI_CONTROL_GROUP_LE_AUDIO << 8 ) | 0x10 )  /* Event for BIS information*/
#define HCI_CONTROL_LE_AUDIO_EVENT_MICS_AICS_DESC           ( ( HCI_CONTROL_GROUP_LE_AUDIO << 8 ) | 0x11 )  /* Event to notify MICS AICS description*/
#define HCI_CONTROL_LE_AUDIO_EVENT_MICS_MUTE_STATUS                                                                     \
    ((HCI_CONTROL_GROUP_LE_AUDIO << 8) | 0x12) /* Event to notify MICS mute status*/
#define HCI_CONTROL_LE_AUDIO_EVENT_MICS_AICS_INPUT_STATUS   ( ( HCI_CONTROL_GROUP_LE_AUDIO << 8 ) | 0x13 )  /* Event to notify MICS AICS input status*/
#define HCI_CONTROL_LE_AUDIO_EVENT_PRESET_RECORD            ( ( HCI_CONTROL_GROUP_LE_AUDIO << 8 ) | 0x14 )  /* Event to send preset record */
#define HCI_CONTROL_LE_AUDIO_EVENT_ACTIVE_PRESET            ( ( HCI_CONTROL_GROUP_LE_AUDIO << 8 ) | 0x15 )   /* Event to notify active preset */
#define HCI_CONTROL_LE_AUDIO_EVENT_PACS_RECORD              ( ( HCI_CONTROL_GROUP_LE_AUDIO << 8 ) | 0x16 )   /* Event to send PACS record */
#define HCI_CONTROL_LE_AUDIO_EVENT_CONVO_STREAM_STATE       ( ( HCI_CONTROL_GROUP_LE_AUDIO << 8 ) | 0X17 )  /* Event to notify bidir mic state */
#define HCI_CONTROL_LE_AUDIO_EVENT_CSIS_LOCK_STATE          ( ( HCI_CONTROL_GROUP_LE_AUDIO << 8 ) | 0x18 )  /* Event to update the lock state */
#define HCI_CONTROL_LE_AUDIO_EVENT_DEVICE_APPEARANCE        ( ( HCI_CONTROL_GROUP_LE_AUDIO << 8 ) | 0x19 )  /* Event to update the device appearance */
...
#define HCI_CONTROL_RAS_CS_EVENT_SECURITY_ENABLE                    ( ( HCI_CONTROL_GROUP_RAS << 8 ) | 0x08 ) /* CS Security complete */
#define HCI_CONTROL_RAS_CS_EVENT_READ_REMOTE_CAPABILITIES_COMPLETE  ( ( HCI_CONTROL_GROUP_RAS << 8 ) | 0x09 ) /* CS Read remote capabilities complete */
#define HCI_CONTROL_RAS_CS_EVENT_READ_REMOTE_FAE_TABLE_COMPLETE     ( ( HCI_CONTROL_GROUP_RAS << 8 ) | 0x0a ) /* CS Read remote FAE table complete */
#define HCI_CONTROL_RAS_CS_EVENT_CS_CONFIG_COMPLETE                 ( ( HCI_CONTROL_GROUP_RAS << 8 ) | 0x0b ) /* CS config complete event */
#define HCI_CONTROL_RAS_CS_EVENT_PROCEDURE_ENABLE                   ( ( HCI_CONTROL_GROUP_RAS << 8 ) | 0x0d ) /* CS Procedure enabled */
#define HCI_CONTROL_RAS_CS_EVENT_PROCEDURE_DONE                     ( ( HCI_CONTROL_GROUP_RAS << 8 ) | 0x0e ) /* CS Procedure done */
...
#define HCI_CONTROL_PANNAP_STATUS_SUCCESS                     4   /* Connection successfully opened */
#define HCI_CONTROL_PANNAP_STATUS_FAIL_SDP                    5   /* Open failed due to SDP */
#define HCI_CONTROL_PANNAP_STATUS_FAIL_RFCOMM                 6   /* Open failed due to RFCOMM */
#define HCI_CONTROL_PANNAP_STATUS_FAIL_CONN_TOUT              7   /* Link loss occured due to connection timeout */
...
#define HCI_CONTROL_LEA_BROADCAST_BIG_SYNC_TERMINATED  5
...
#define HCI_CONTROL_MISC_APP_STATE_CONNECTED 0
#define HCI_CONTROL_MISC_APP_STATE_MTU_CONFIGURED 1
#define HCI_CONTROL_MISC_APP_STATE_BONDING_COMPLETED 2
#define HCI_CONTROL_MISC_APP_STATE_DISCOVERY_COMPLETE 3
#define HCI_CONTROL_MISC_APP_STATE_INITING 4
#define HCI_CONTROL_MISC_APP_STATE_READY 5
#define HCI_CONTROL_MISC_APP_STATE_DISCONNECTING 6
#define HCI_CONTROL_MISC_APP_STATE_DISCONNECTED 7

#define HCI_CONTROL_MISC_APP_STATE_INIT_NOTIFYING 0
#define HCI_CONTROL_MISC_APP_STATE_INIT_ENABLING 1
#define HCI_CONTROL_MISC_APP_STATE_INIT_READING 2

#define HCI_CONTROL_LEA_MICS_AICS_GAIN_INCREMENT 1
#define HCI_CONTROL_LEA_MICS_AICS_GAIN_DECREMENT 2
#define HCI_CONTROL_LEA_MICS_AICS_SET_ABSOLUTE_GAIN 3
